...
class VisaRequirementsStep extends StatelessWidget {
  const VisaRequirementsStep({super.key});
  ...
  static const List<Map<String, dynamic>> visaTypes = [
    {
      ...
      'benefits': ['Sponsor family', 'Multiple entry', 'Work permit included'],
      'requirements': [
        'Company ownership',
        'Minimum investment',
        'Emirates ID'
    ...
    },
    {
      ...
      'benefits': [
        'Work permit',
        'Sponsor family (conditions apply)',
        'Healthcare'
      ],
      'requirements': [
        'Employment contract',
    ...
    },
    {
      ...
      'benefits': ['Work independently', 'Multiple clients', 'Flexible terms'],
      'requirements': [
              ...
              Expanded(
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return _buildVisaCard(context, provider, visa);
                  },
                ),
              ),
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          IconButton(
                            onPressed: provider.numberOfVisas > 0
                                ? () => provider.setNumberOfVisas(
                                      provider.numberOfVisas - 1,
                                    )
                                : null,
                            icon: const Icon(Icons.remove_circle_outline),
                            iconSize: 28,
                            color: provider.numberOfVisas > 0
                                ? AppColors.primary
                                : Colors.grey,
                          ),
                          Expanded(
                          ...
                          IconButton(
                            onPressed: provider.numberOfVisas < 20
                                ? () => provider.setNumberOfVisas(
                                      provider.numberOfVisas + 1,
                                    )
                                : null,
                            ...
                            iconSize: 28,
                            color: provider.numberOfVisas < 20
                                ? AppColors.primary
                                : Colors.grey,
                          ),
                        ],
                      ...
                      Wrap(
                        ...
                        children: [1, 2, 3, 5, 10].map((count) {
                          final isSelected = provider.numberOfVisas == count;
                          return GestureDetector(
                            onTap: () => provider.setNumberOfVisas(count),
                            child: Container(
                        ...
                        Container(
                          ...
                          child: Row(
                            children: [
                              ...
                              Expanded(
                                child: Text(
                                  'Estimated cost: ${_calculateVisaCost(provider.visaType!, provider.numberOfVisas)}',
                                  style: TextStyle(
                                    fontSize: 14,
                                    color: Colors.blue[700],
                                    fontWeight: FontWeight.w500,
  ...
  Widget _buildVisaCard(
    ...
    final isSelected = provider.visaType == visa['id'];
    ...
    return Container(
      ...
      child: Material(
        ...
        child: InkWell(
          onTap: () {
            provider.setVisaType(visa['id']);
            if (provider.numberOfVisas == 0) {
              provider.setNumberOfVisas(1);
            }
          },
          borderRadius: BorderRadius.circular(12),
          child: Container(
