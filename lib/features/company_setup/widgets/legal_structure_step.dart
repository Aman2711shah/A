...
class LegalStructureStep extends StatelessWidget {
  const LegalStructureStep({super.key});
  ...
  static const List<Map<String, dynamic>> legalStructures = [
    ...
    },
    {
      ...
      'description': 'For market research and business development',
              ...
              Expanded(
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return _buildStructureCard(context, provider, structure);
                  },
                ),
              ),

              // Information Panel for Selected Structure
              if (provider.selectedLegalStructure != null)
                _buildInfoPanel(provider.selectedLegalStructure!),
            ],
          ),
        );
      },
  ...
  Widget _buildStructureCard(
    ...
    final isSelected = provider.selectedLegalStructure == structure['id'];
    ...
    return Container(
      ...
      child: Material(
        ...
        child: InkWell(
          onTap: () {
            provider.setSelectedLegalStructure(structure['id']);
          },
          borderRadius: BorderRadius.circular(12),
          child: Container(
  ...
  String _getStructureInfo(String structureId) {
    switch (structureId) {
      ...
      case 'branch':
        return 'Extension of an existing foreign company. The parent company is fully liable for all operations. Cannot engage in activities different from the parent company.';
      case 'representative_office':
        return 'Limited to market research, feasibility studies, and business development. Cannot conduct commercial activities or generate revenue in the UAE.';
      default:
        return '';
    }
  }
